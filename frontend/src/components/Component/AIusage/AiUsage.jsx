...
const AiUsage = () => {
  ...
  const liveLogs = [
    { id: 104, model: "GPT-4", prompt: "Summarize this PDF...", user: "User_882", time: "2s ago" },
    { id: 103, model: "Gemini", prompt: "Write an email response...", user: "User_110", time: "5s ago" },
    { id: 102, model: "GPT-4", prompt: "Translate to Spanish...", user: "User_543", time: "12s ago" },
    { id: 101, model: "Gemini", prompt: "Extract dates from text...", user: "User_991", time: "30s ago" },
  ];
    ...
    <div className="page-container">
      ...
      <div className="content-wrap">
        <header className="page-header">
          <h1>AI Usage & Logs</h1>
          <p>Monitor token consumption, costs, and model performance.</p>
        </header>
              ...
              <tbody>
                {topSpenders.map((user, i) => (
                  <tr key={i}>
                    ...
                    <td>{user.spent}</td>
                    <td><span className={`pill ${user.plan.toLowerCase()}`}>{user.plan}</span></td>
                    <td>
                      {user.plan === 'Free' ? (
          ...
          <div className="log-console">
            {liveLogs.map(log => (
              <div key={log.id} className="log-entry">
                ...
                <span className={`log-model ${log.model.toLowerCase()}`}>{log.model}</span>
