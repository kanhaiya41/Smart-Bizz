...
import heroImg from "./assets/photo-1551434678-e076c223a692.jpg.jpeg";
...
const Landingpage=()=>
{
  ...
  return(
    <>
      <nav>
        <div className="logo">SmartBiz</div>
        <div className="nav-links">
          <a href="#">Solutions</a>
          <a href="#">Pricing</a>
          <a href="#">Resources</a>
        </div>
        <button className="btn-purple">Start Free Trial</button>
      </nav>
      ...
      <section className="hero">
        <div className="hero-text">
          ...
          <button className="btn-purple2" style={{ padding: "20px 45px", fontSize: "18px" }}>
      ...
      <div className="sticky-container" id="sticky-trigger">
            ...
            <div style={{ position: "relative", height: "400px" }}>
              ...
              <div className="feature-item" id="f3">
                ...
                <p>
                  ...
                  Keep pricing and availability aligned across all conversations.
